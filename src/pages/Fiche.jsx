...
const Fiche = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      content: (
        <ul>
          {location.equipments.map((equipement) => (
            <li key={`equipment-${equipement}`}>{equipement}</li>
          ))}
        </ul>
      ),
    },
    ...
    <div className="fiche">
      <div className="carousel">
        ...
        <img
          ...
          alt={`${location.title} - ${currentImageIndex + 1}`}
      ...
      <div className="fiche-content">
        ...
        <div className="right-column">
          ...
          <div
            className="rating"
            aria-label={`Rating: ${location.rating} out of 5 stars`}
          >
            {[1, 2, 3, 4, 5].map((star) => (
              <span
                key={`star-${star}`}
                className={star <= location.rating ? "star filled" : "star"}
              >
                ★
              </span>
            ))}
      ...
      <div className="menu-container">
        {menuItems.map((item) => (
          <div key={`menu-${item.title}`} className="menu-item">
            <div className="menu-header">
              ...
              >
                ...
                <span
                  className={`arrow ${
                    openMenus.includes(item.title) ? "open" : ""
                  }`}
                >
                  ▼
                </span>
